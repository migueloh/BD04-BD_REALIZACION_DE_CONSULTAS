...
SELECT CLIENTES.NOMBRECLIENTE AS "CLIENTE",EMPLEADOS.APELLIDO1||' '|| EMPLEADOS.APELLIDO2 AS "REPRESENTANTE"
...
AND (PAGOS.CANTIDAD>=(SELECT MAX(PAGOS.CANTIDAD)FROM PAGOS)
OR PAGOS.CANTIDAD<=(SELECT MIN(PAGOS.CANTIDAD)FROM PAGOS));


/*3*/

SELECT CLIENTES.CODIGOCLIENTE,CLIENTES.NOMBRECLIENTE,UPPER(PEDIDOS.ESTADO),COUNT(PEDIDOS.CODIGOPEDIDO) AS"PEDIDOS"
FROM CLIENTES,PEDIDOS
WHERE CLIENTES.CODIGOCLIENTE=PEDIDOS.CODIGOCLIENTE
GROUP BY CLIENTES.CODIGOCLIENTE,CLIENTES.NOMBRECLIENTE,UPPER(PEDIDOS.ESTADO)
ORDER BY CLIENTES.CODIGOCLIENTE,CLIENTES.NOMBRECLIENTE,UPPER(PEDIDOS.ESTADO);

/*4*/

SELECT EMPLEADOS.CODIGOEMPLEADO,COUNT(CLIENTES.CODIGOCLIENTE)
